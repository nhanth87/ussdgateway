...
//    private AtomicLong currentDialogId = new AtomicLong(1);
    ...
    private transient NonBlockingHashMap<String, Integer> lstUserPartCongestionLevel = new NonBlockingHashMap<>();
            ...
            // boost
                case TCContinueMessage._TAG:
                    ...
                    if (dialog == null) {
                        ...
                        logger.debug("Adding NetworkId to dialog in continue" + sccpDataMessage.getNetworkId());
                ...
                case TCBeginMessage._TAG:
                    ...
                    logger.debug("Adding NetworkId to dialog in begin" + sccpDataMessage.getNetworkId());
                    dialog.setNetworkId(sccpDataMessage.getNetworkId());
                ...
                case TCAbortMessage._TAG:
                    ...
                    if (dialog == null) {
                        ...
                        logger.debug("Adding NetworkId to dialog in abort" + sccpDataMessage.getNetworkId());
                        dialog.setNetworkId(sccpDataMessage.getNetworkId());
