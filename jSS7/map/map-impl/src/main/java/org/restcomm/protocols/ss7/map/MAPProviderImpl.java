...
//    }
    ...
    public void onTCBegin(TCBeginIndication tcBeginIndication) {
        ...
        if (userInfo == null) {
            ...
            try {
                ...
                eriStyle = mapOpenInfoImpl.getEricssonStyle();
        ...
        try {
            ...
            if (this.getTCAPProvider().getPreviewMode()) {
                ...
                dimp.getPreviewDialogData().setUpperDialog(mapDialogImpl);
            }
        } finally {
    ...
    public void onTCContinue(TCContinueIndication tcContinueIndication) {
        ...
        if (this.getTCAPProvider().getPreviewMode()) {
            mapDialogImpl = (MAPDialogImpl) (((DialogImpl) tcapDialog).getPreviewDialogData().getUpperDialog());
        } else {
...
//                    .tail(); (n = n.getNext()) != end;) {
    ...
    protected TCBeginRequest encodeTCBegin(Dialog tcapDialog, ApplicationContextName acn, AddressString destReference,
        ...
        if ((destReference != null || origReference != null || mapExtensionContainer != null || eriStyle)
            ...
            mapOpn.setEricssonStyle(eriStyle);
            mapOpn.setEricssonMsisdn(eriMsisdn);
            mapOpn.setEricssonVlrNo(eriVlrNo);
