...
public abstract class MAPDialogImpl implements MAPDialog {
    ...
    protected MAPApplicationContext mapApplicationContext;
    ...
    protected MAPDialogImpl(MAPApplicationContext mapApplicationContext, Dialog tcapDialog, MAPProviderImpl mapProviderImpl,
    ...
    public Boolean isDoNotSendProtocolVersion() {
        return tcapDialog.isDoNotSendProtocolVersion();
    }
    ...
    public void setExtensionContainer(MAPExtensionContainer extContainer) {
            ...
            switch (this.tcapDialog.getState()) {
                case InitialReceived:
                    ApplicationContextName acn = this.mapProviderImpl.getTCAPProvider().getDialogPrimitiveFactory()
                            .createApplicationContextName(this.mapApplicationContext.getOID());
    ...
    public String toString() {
        ...
        sb.append("MAPDialog: LocalDialogId=").append(this.getLocalDialogId()).append(" RemoteDialogId=")
                ...
                .append(" MAPApplicationContext=").append(this.mapApplicationContext).append(" TCAPDialogState=")
