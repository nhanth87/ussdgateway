    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        try {
            ...
            if (this.psSubscriberState != null) {
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _ID_psSubscriberState);
                int pos = asnOutputStream.StartContentDefiniteLength();
            ...
            if (this.msClassmark2 != null)
                ((MSClassmark2Impl) this.msClassmark2).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_msclassmark2);

            if (this.gprsMSClass != null)
                ((GPRSMSClassImpl) this.gprsMSClass).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_gprsMSClass);

            if (this.mnpInfoRes != null)
                ((MNPInfoResImpl) this.mnpInfoRes).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_mnpInfoRes);
