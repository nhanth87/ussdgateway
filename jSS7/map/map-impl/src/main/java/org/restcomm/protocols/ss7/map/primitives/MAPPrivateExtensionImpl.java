...
public class MAPPrivateExtensionImpl implements MAPPrivateExtension, MAPAsnPrimitive {
    ...
    public void decodeAll(AsnInputStream asnInputStream) throws MAPParsingComponentException {
        ...
        try {
            AsnInputStream ais = asnInputStream.readSequenceStream();
            this._decode(ais);
        } catch (IOException e) {
    ...
    private void _decode(AsnInputStream asnInputStream) throws MAPParsingComponentException, IOException, AsnException {
        ...
        if (tag != Tag.OBJECT_IDENTIFIER || asnInputStream.getTagClass() != Tag.CLASS_UNIVERSAL || !asnInputStream.isTagPrimitive())
