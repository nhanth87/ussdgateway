 ...
 *
 */
@JacksonXmlRootElement(localName = "pDPContextInfoImpl")
public class PDPContextInfoImpl implements PDPContextInfo, MAPAsnPrimitive {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        try {
            ...
            asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_pdpContextIdentifier, this.pdpContextIdentifier);

            if (this.pdpContextActive)
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_pdpContextActive);

            if (this.pdpType != null)
                ((PDPTypeImpl) this.pdpType).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_pdpType);
            ...
            if (this.apnSubscribed != null)
                ((APNImpl) this.apnSubscribed).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_apnSubscribed);

            if (this.apnInUse != null)
                ((APNImpl) this.apnInUse).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_apnInUse);

            if (this.nsapi != null)
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_nsapi, this.nsapi);

            if (this.transactionId != null)
                ((TransactionIdImpl) this.transactionId).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_transactionId);

            if (this.teidForGnAndGp != null)
                ((TEIDImpl) this.teidForGnAndGp).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_teidForGnAndGp);

            if (this.teidForIu != null)
                ((TEIDImpl) this.teidForIu).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_teidForIu);

            if (this.ggsnAddress != null)
                ((GSNAddressImpl) this.ggsnAddress).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_ggsnAddress);

            if (this.qosSubscribed != null)
                ((ExtQoSSubscribedImpl) this.qosSubscribed).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_qosSubscribed);

            if (this.qosRequested != null)
                ((ExtQoSSubscribedImpl) this.qosRequested).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_qosRequested);

            if (this.qosNegotiated != null)
                ((ExtQoSSubscribedImpl) this.qosNegotiated).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_qosNegotiated);

            if (this.chargingId != null)
                ((GPRSChargingIDImpl) this.chargingId).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_chargingId);
            ...
            if (this.rncAddress != null)
                ((GSNAddressImpl) this.rncAddress).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_rncAddress);
            ...
            if (this.qos2Subscribed != null)
                ((Ext2QoSSubscribedImpl) this.qos2Subscribed).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_qos2Subscribed);

            if (this.qos2Requested != null)
                ((Ext2QoSSubscribedImpl) this.qos2Requested).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_qos2Requested);

            if (this.qos2Negotiated != null)
                ((Ext2QoSSubscribedImpl) this.qos2Negotiated).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_qos2Negotiated);

            if (this.qos3Subscribed != null)
                ((Ext3QoSSubscribedImpl) this.qos3Subscribed).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_qos3Subscribed);

            if (this.qos3Requested != null)
                ((Ext3QoSSubscribedImpl) this.qos3Requested).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_qos3Requested);

            if (this.qos3Negotiated != null)
                ((Ext3QoSSubscribedImpl) this.qos3Negotiated).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_qos3Negotiated);

            if (this.qos4Subscribed != null)
                ((Ext4QoSSubscribedImpl) this.qos4Subscribed).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_qos4Subscribed);

            if (this.qos4Requested != null)
                ((Ext4QoSSubscribedImpl) this.qos4Requested).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_qos4Requested);

            if (this.qos4Negotiated != null)
                ((Ext4QoSSubscribedImpl) this.qos4Negotiated).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_qos4Negotiated);

            if (this.extPdpType != null)
                ((ExtPDPTypeImpl) this.extPdpType).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_extPdpType);

            if (this.extPdpAddress != null)
                ((PDPAddressImpl) this.extPdpAddress).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_extPdpAddress);
