 ...
 *
 */
@JacksonXmlRootElement(localName = "gPRSMSClassImpl")
public class GPRSMSClassImpl implements GPRSMSClass, MAPAsnPrimitive {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        ...
        ((MSNetworkCapabilityImpl) this.mSNetworkCapability).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
                _ID_mSNetworkCapability);

        if (this.mSRadioAccessCapability != null)
            ((MSRadioAccessCapabilityImpl) this.mSRadioAccessCapability).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
