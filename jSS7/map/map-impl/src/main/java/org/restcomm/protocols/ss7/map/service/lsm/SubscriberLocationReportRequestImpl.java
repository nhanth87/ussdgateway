...
public class SubscriberLocationReportRequestImpl extends LsmMessageImpl implements SubscriberLocationReportRequest {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        ...
        try {
            asnOutputStream.writeInteger(Tag.CLASS_UNIVERSAL, Tag.ENUMERATED, this.lcsEvent.getEvent());
        } catch (IOException e) {
        ...
        if (this.ageOfLocationEstimate != null) {
            try {
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _TAG_AGE_OF_LOCATION_ESTIMATE, this.ageOfLocationEstimate);
            } catch (IOException e) {
        ...
        if (this.slrArgExtensionContainer != null) {
            // slr-ArgExtensionContainer [7] SLR-ArgExtensionContainer
            ((SLRArgExtensionContainerImpl) this.slrArgExtensionContainer).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
        ...
        if (this.deferredmtlrData != null) {
            ...
            ((DeferredmtlrDataImpl) this.deferredmtlrData).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
        ...
        if (this.lcsReferenceNumber != null) {
            ...
            try {
                asnOutputStream.writeOctetString(Tag.CLASS_CONTEXT_SPECIFIC, _TAG_LCS_REFERENCE_NUMBER,
        ...
        if (this.utranPositioningData != null) {
            ...
            ((UtranPositioningDataInfoImpl) this.utranPositioningData).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
