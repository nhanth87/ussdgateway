...
public class TChangeOfPositionSpecificInfoTest {
    ...
    public void testDecode() throws Exception {
        ...
        TChangeOfPositionSpecificInfoImpl elem = new TChangeOfPositionSpecificInfoImpl();
        int tag = ais.readTag();
        ...
        elem = new TChangeOfPositionSpecificInfoImpl();
        tag = ais.readTag();
        assertEquals(tag, Tag.SEQUENCE);
        assertEquals(ais.getTagClass(), Tag.CLASS_UNIVERSAL);
    ...
    public void testEncode() throws Exception {
        ...
        TChangeOfPositionSpecificInfoImpl elem = new TChangeOfPositionSpecificInfoImpl(locationInformation, null);
        ...
        elem = new TChangeOfPositionSpecificInfoImpl(locationInformation, metDPCriteriaList);
