...
public class PromptAndCollectUserInformationRequestTest {
    ...
    public void testDecode() throws Exception {
        ...
        elem.decodeAll(ais);
        assertEquals(elem.getCollectedInfo().getCollectedDigits().getMaximumNumberOfDigits(), 10);
        assertNull(elem.getCollectedInfo().getCollectedDigits().getMinimumNumberOfDigits());
        ...
        assertNull(elem.getCollectedInfo().getCollectedDigits().getInterruptableAnnouncementIndicator());
