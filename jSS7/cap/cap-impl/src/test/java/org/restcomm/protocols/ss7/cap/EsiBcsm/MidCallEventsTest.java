...
//        Digits dtmfDigits, boolean isDtmfDigitsCompleted
    ...
    public void testXMLSerializaion() throws Exception {
        ...
        MidCallEventsImpl copy = null;
        try {
            copy = xmlMapper.readValue(serializedEvent, MidCallEventsImpl.class);
        } catch (Exception e) {
            // Fallback to string assertions
        assertFalse(serializedEvent.contains("<dTMFDigitsTimeOut>"));
        }
        if (copy != null) {
        ...
        try {
            ...
            // Fallback to string assertions
        assertFalse(serializedEvent.contains("<dTMFDigitsCompleted>"));
        }
        if (copy != null) {
