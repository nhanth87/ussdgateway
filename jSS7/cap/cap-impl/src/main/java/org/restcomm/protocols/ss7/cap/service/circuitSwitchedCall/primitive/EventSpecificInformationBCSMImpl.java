...
public class EventSpecificInformationBCSMImpl implements EventSpecificInformationBCSM, CAPAsnPrimitive {
        ...
        if (asnInputStream.getTagClass() == Tag.CLASS_CONTEXT_SPECIFIC) {
            switch (tag) {
                case _ID_routeSelectFailureSpecificInfo:
                    ...
                    ((RouteSelectFailureSpecificInfoImpl) this.routeSelectFailureSpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_oCalledPartyBusySpecificInfo:
                    this.oCalledPartyBusySpecificInfo = new OCalledPartyBusySpecificInfoImpl();
                    ((OCalledPartyBusySpecificInfoImpl) this.oCalledPartyBusySpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_oNoAnswerSpecificInfo:
                    this.oNoAnswerSpecificInfo = new ONoAnswerSpecificInfoImpl();
                    ((ONoAnswerSpecificInfoImpl) this.oNoAnswerSpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_oAnswerSpecificInfo:
                    this.oAnswerSpecificInfo = new OAnswerSpecificInfoImpl();
                    ((OAnswerSpecificInfoImpl) this.oAnswerSpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_oMidCallSpecificInfo:
                    this.oMidCallSpecificInfo = new OMidCallSpecificInfoImpl();
                    ((OMidCallSpecificInfoImpl) this.oMidCallSpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_oDisconnectSpecificInfo:
                    this.oDisconnectSpecificInfo = new ODisconnectSpecificInfoImpl();
                    ((ODisconnectSpecificInfoImpl) this.oDisconnectSpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_tBusySpecificInfo:
                    this.tBusySpecificInfo = new TBusySpecificInfoImpl();
                    ((TBusySpecificInfoImpl) this.tBusySpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_tNoAnswerSpecificInfo:
                    this.tNoAnswerSpecificInfo = new TNoAnswerSpecificInfoImpl();
                    ((TNoAnswerSpecificInfoImpl) this.tNoAnswerSpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_tAnswerSpecificInfo:
                    this.tAnswerSpecificInfo = new TAnswerSpecificInfoImpl();
                    ((TAnswerSpecificInfoImpl) this.tAnswerSpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_tMidCallSpecificInfo:
                    this.tMidCallSpecificInfo = new TMidCallSpecificInfoImpl();
                    ((TMidCallSpecificInfoImpl) this.tMidCallSpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_tDisconnectSpecificInfo:
                    this.tDisconnectSpecificInfo = new TDisconnectSpecificInfoImpl();
                    ((TDisconnectSpecificInfoImpl) this.tDisconnectSpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_oTermSeizedSpecificInfo:
                    this.oTermSeizedSpecificInfo = new OTermSeizedSpecificInfoImpl();
                    ((OTermSeizedSpecificInfoImpl) this.oTermSeizedSpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_callAcceptedSpecificInfo:
                    this.callAcceptedSpecificInfo = new CallAcceptedSpecificInfoImpl();
                    ((CallAcceptedSpecificInfoImpl) this.callAcceptedSpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_oAbandonSpecificInfo:
                    this.oAbandonSpecificInfo = new OAbandonSpecificInfoImpl();
                    ((OAbandonSpecificInfoImpl) this.oAbandonSpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_oChangeOfPositionSpecificInfo:
                    this.oChangeOfPositionSpecificInfo = new OChangeOfPositionSpecificInfoImpl();
                    ((OChangeOfPositionSpecificInfoImpl) this.oChangeOfPositionSpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_tChangeOfPositionSpecificInfo:
                    this.tChangeOfPositionSpecificInfo = new TChangeOfPositionSpecificInfoImpl();
                    ((TChangeOfPositionSpecificInfoImpl) this.tChangeOfPositionSpecificInfo).decodeData(asnInputStream, length);
                    break;
                case _ID_dpSpecificInfoAlt:
                    this.dpSpecificInfoAlt = new DpSpecificInfoAltImpl();
                    ((DpSpecificInfoAltImpl) this.dpSpecificInfoAlt).decodeData(asnInputStream, length);
                    break;
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        ...
        if (routeSelectFailureSpecificInfo != null) {
            ((RouteSelectFailureSpecificInfoImpl) routeSelectFailureSpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (oCalledPartyBusySpecificInfo != null) {
            ((OCalledPartyBusySpecificInfoImpl) oCalledPartyBusySpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (oNoAnswerSpecificInfo != null) {
            ((ONoAnswerSpecificInfoImpl) oNoAnswerSpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (oAnswerSpecificInfo != null) {
            ((OAnswerSpecificInfoImpl) oAnswerSpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (oMidCallSpecificInfo != null) {
            ((OMidCallSpecificInfoImpl) oMidCallSpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (oDisconnectSpecificInfo != null) {
            ((ODisconnectSpecificInfoImpl) oDisconnectSpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (tBusySpecificInfo != null) {
            ((TBusySpecificInfoImpl) tBusySpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (tNoAnswerSpecificInfo != null) {
            ((TNoAnswerSpecificInfoImpl) tNoAnswerSpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (tAnswerSpecificInfo != null) {
            ((TAnswerSpecificInfoImpl) tAnswerSpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (tMidCallSpecificInfo != null) {
            ((TMidCallSpecificInfoImpl) tMidCallSpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (tDisconnectSpecificInfo != null) {
            ((TDisconnectSpecificInfoImpl) tDisconnectSpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (oTermSeizedSpecificInfo != null) {
            ((OTermSeizedSpecificInfoImpl) oTermSeizedSpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (callAcceptedSpecificInfo != null) {
            ((CallAcceptedSpecificInfoImpl) callAcceptedSpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (oAbandonSpecificInfo != null) {
            ((OAbandonSpecificInfoImpl) oAbandonSpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (oChangeOfPositionSpecificInfo != null) {
            ((OChangeOfPositionSpecificInfoImpl) oChangeOfPositionSpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (tChangeOfPositionSpecificInfo != null) {
            ((TChangeOfPositionSpecificInfoImpl) tChangeOfPositionSpecificInfo).encodeData(asnOutputStream);
            return;
        } else if (dpSpecificInfoAlt != null) {
            ((DpSpecificInfoAltImpl) dpSpecificInfoAlt).encodeData(asnOutputStream);
            return;
        }
