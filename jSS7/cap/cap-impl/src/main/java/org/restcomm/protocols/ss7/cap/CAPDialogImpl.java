...
public abstract class CAPDialogImpl implements CAPDialog {
    ...
    protected CAPApplicationContext capApplicationContext;
    ...
    protected CAPDialogImpl(CAPApplicationContext capApplicationContext, Dialog tcapDialog, CAPProviderImpl capProviderImpl,
            CAPServiceBase capServiceBase) {
            ...
            switch (this.tcapDialog.getState()) {
                ...
                case Idle:
                    ApplicationContextName acn = this.capProviderImpl.getTCAPProvider().getDialogPrimitiveFactory()
                            .createApplicationContextName(this.capApplicationContext.getOID());
    ...
    public void sendErrorComponent(Long invokeId, CAPErrorMessage mem) throws CAPException {
        ...
        try {
            ...
            // Error Code
            ErrorCode errorCode = TcapFactory.createErrorCode();
            errorCode.setLocalErrorCode(capErrorMessage.getErrorCode());
            returnError.setErrorCode(errorCode);
            ...
            if (buf.length != 0) {
                ...
                parameter.setTagClass(capErrorMessage.getTagClass());
                parameter.setPrimitive(capErrorMessage.getIsPrimitive());
                parameter.setTag(capErrorMessage.getTag());
                parameter.setData(buf);
    ...
    public String toString() {
        ...
        sb.append("CAPDialog: LocalDialogId=").append(this.getLocalDialogId()).append(" RemoteDialogId=")
                ...
                .append(" CAPApplicationContext=").append(this.capApplicationContext).append(" TCAPDialogState=")
