...
public class FCIBCCCAMELsequence1SMSImpl extends SequenceBase implements FCIBCCCAMELsequence1SMS {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        ...
        try {
            ...
            ((FreeFormatDataSMSImpl) this.freeFormatData).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_freeFormatData);

            if (this.appendFreeFormatData != null) {
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_appendFreeFormatData,
