    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        try {
            ...
            if (this.legID != null) {
                ...
                ((LegIDImpl) this.legID).encodeAll(asnOutputStream);
                asnOutputStream.FinalizeContent(pos);
            }

            if (this.dpSpecificCriteria != null) {
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _ID_dpSpecificCriteria);
                int pos = asnOutputStream.StartContentDefiniteLength();
            ...
            if (this.automaticRearm) {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_automaticRearm);
            }
        } catch (IOException e) {
