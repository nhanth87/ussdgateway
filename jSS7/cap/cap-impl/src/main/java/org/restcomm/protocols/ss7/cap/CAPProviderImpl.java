...
//    protected transient FastMap<Long, CAPDialogImpl> dialogs = new FastMap<Long, CAPDialogImpl>().shared();
    ...
    private CAPGprsReferenceNumberImpl ParseUserInfo(UserInformation userInfo, Dialog dialog) {
        ...
        // Parsing userInfo
        CAPGprsReferenceNumberImpl referenceNumber;
    ...
    public void onTCBegin(TCBeginIndication tcBeginIndication) {
        ...
        try {
            ...
            if (this.getTCAPProvider().getPreviewMode()) {
                ...
                dimp.getPreviewDialogData().setUpperDialog(capDialogImpl);
            }
        } finally {
    ...
    public void onTCContinue(TCContinueIndication tcContinueIndication) {
        ...
        if (this.getTCAPProvider().getPreviewMode()) {
            capDialogImpl = (CAPDialogImpl) (((DialogImpl) tcapDialog).getPreviewDialogData().getUpperDialog());
        } else {
    ...
    public void onTCNotice(TCNoticeIndication tcNoticeIndication) {
        ...
        Dialog tcapDialog = tcNoticeIndication.getDialog();
    ...
    private void doProcessComponent(CAPDialogImpl capDialogImpl, Component component) {
        ...
        try {
            ComponentType compType = component.getType();
            ...
            switch (compType) {
                ...
                case ReturnResultLast: {
                    ReturnResultLast comp = (ReturnResultLast) component;
                    oc = comp.getOperationCode();
                    parameter = comp.getParameter();
                }
                    break;
                ...
                case ReturnError: {
                    ReturnError comp = (ReturnError) component;
