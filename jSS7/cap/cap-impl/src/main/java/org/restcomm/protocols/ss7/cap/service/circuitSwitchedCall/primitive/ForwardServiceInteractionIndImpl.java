...
*
*/
@JacksonXmlRootElement(localName = "forwardServiceInteractionInd")
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        try {
            if (this.conferenceTreatmentIndicator != null) {
                ...
                asnOutputStream.writeOctetString(Tag.CLASS_CONTEXT_SPECIFIC, _ID_conferenceTreatmentIndicator, data);
            }
            if (this.callDiversionTreatmentIndicator != null) {
                byte[] data = new byte[] { (byte) this.callDiversionTreatmentIndicator.getCode() };
                asnOutputStream.writeOctetString(Tag.CLASS_CONTEXT_SPECIFIC, _ID_callDiversionTreatmentIndicator, data);
            }
            if (this.callingPartyRestrictionIndicator != null) {
                byte[] data = new byte[] { (byte) this.callingPartyRestrictionIndicator.getCode() };
                asnOutputStream.writeOctetString(Tag.CLASS_CONTEXT_SPECIFIC, _ID_callingPartyRestrictionIndicator, data);
            }
