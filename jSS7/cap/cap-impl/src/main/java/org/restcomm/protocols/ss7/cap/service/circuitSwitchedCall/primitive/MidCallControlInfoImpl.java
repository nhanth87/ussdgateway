...
public class MidCallControlInfoImpl extends SequenceBase implements MidCallControlInfo {
    ...
    private String readStringData(AsnInputStream asnInputStream, String parameterName) throws CAPParsingComponentException {
        try {
            byte[] val = asnInputStream.readOctetString();
    ...
    private void writeStringData(AsnOutputStream asnOutputStream, int tag, String value, String parameterName) throws CAPException {
        ...
        try {
            asnOutputStream.writeOctetString(Tag.CLASS_CONTEXT_SPECIFIC, tag, val);
        } catch (IOException e) {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        try {
            ...
            if (this.endOfReplyDigit != null) {
                writeStringData(asnOutputStream, _ID_endOfReplyDigit, this.endOfReplyDigit, "endOfReplyDigit");
            }
            if (this.cancelDigit != null) {
                writeStringData(asnOutputStream, _ID_cancelDigit, this.cancelDigit, "cancelDigit");
            }
            if (this.startDigit != null) {
                writeStringData(asnOutputStream, _ID_startDigit, this.startDigit, "startDigit");
            }
