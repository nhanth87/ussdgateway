...
public class InitiateCallAttemptRequestImpl extends CircuitSwitchedCallMessageImpl implements InitiateCallAttemptRequest {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        ...
        try {
            ((DestinationRoutingAddressImpl) this.destinationRoutingAddress).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_destinationRoutingAddress);
            ...
            if (this.legToBeCreated != null) {
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, this.getIsPrimitive(), _ID_legToBeCreated);
                int pos = asnOutputStream.StartContentDefiniteLength();
                ((LegIDImpl) this.legToBeCreated).encodeAll(asnOutputStream);
                asnOutputStream.FinalizeContent(pos);
            }
            if (this.newCallSegment != null)
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_newCallSegment, this.newCallSegment);
            ...
            if (this.gsmSCFAddress != null)
                ((ISDNAddressStringImpl) this.gsmSCFAddress).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
                        _ID_gsmSCFAddress);
            if (this.suppressTCsi)
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_suppressTCsi);
