...
public class DpSpecificCriteriaAltImpl extends SequenceBase implements DpSpecificCriteriaAlt {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        ...
        try {
            asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _ID_changeOfPositionControlInfo);
            ...
            if (this.numberOfDigits != null)
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_numberOfDigits, this.numberOfDigits);
