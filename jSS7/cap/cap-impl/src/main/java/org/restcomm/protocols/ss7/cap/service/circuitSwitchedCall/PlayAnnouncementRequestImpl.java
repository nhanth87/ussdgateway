...
public class PlayAnnouncementRequestImpl extends CircuitSwitchedCallMessageImpl implements PlayAnnouncementRequest {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        ...
        try {
            ...
            asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _ID_informationToSend);
            int pos = asnOutputStream.StartContentDefiniteLength();
            ((InformationToSendImpl) this.informationToSend).encodeAll(asnOutputStream);
            asnOutputStream.FinalizeContent(pos);

            if (this.disconnectFromIPForbidden != null)
                asnOutputStream.writeBoolean(Tag.CLASS_CONTEXT_SPECIFIC, _ID_disconnectFromIPForbidden, this.disconnectFromIPForbidden);
            if (this.requestAnnouncementCompleteNotification != null)
                asnOutputStream.writeBoolean(Tag.CLASS_CONTEXT_SPECIFIC, _ID_requestAnnouncementCompleteNotification,
            ...
            if (this.requestAnnouncementStartedNotification != null)
                asnOutputStream.writeBoolean(Tag.CLASS_CONTEXT_SPECIFIC, _ID_requestAnnouncementStartedNotification,
