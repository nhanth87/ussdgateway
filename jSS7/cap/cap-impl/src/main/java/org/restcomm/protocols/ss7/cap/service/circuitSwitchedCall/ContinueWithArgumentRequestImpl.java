    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        ...
        try {
            if (alertingPattern != null)
                ((AlertingPatternCapImpl) this.alertingPattern).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
                        _ID_alertingPattern);
            ...
            if (cugInterlock != null)
                ((CUGInterlockImpl) this.cugInterlock).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_cugInterlock);

            if (cugOutgoingAccess)
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_cugOutgoingAccess);

            if (chargeNumber != null)
                ((LocationNumberCapImpl) this.chargeNumber)
                        .encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_chargeNumber);
            ...
            if (borInterrogationRequested)
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_borInterrogationRequested);

            if (suppressOCsi)
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_suppressOCSI);

            if (continueWithArgumentArgExtension != null)
                ((ContinueWithArgumentArgExtensionImpl) this.continueWithArgumentArgExtension).encodeAll(asnOutputStream,
