 ...
 *
 */
@JacksonXmlRootElement(localName = "connectToResourceRequest")
public class ConnectToResourceRequestImpl extends CircuitSwitchedCallMessageImpl implements ConnectToResourceRequest {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        ...
        try {
            ...
            if (this.resourceAddress_IPRoutingAddress != null)
                ((CalledPartyNumberCapImpl) this.resourceAddress_IPRoutingAddress).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
                        _ID_resourceAddress_ipRoutingAddress);
            if (this.resourceAddress_Null)
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_resourceAddress_none);
