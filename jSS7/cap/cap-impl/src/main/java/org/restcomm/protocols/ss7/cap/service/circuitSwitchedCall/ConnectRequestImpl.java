 ...
 */
@JacksonXmlRootElement(localName = "connectRequest")
public class ConnectRequestImpl extends CircuitSwitchedCallMessageImpl implements ConnectRequest {
    ...
    public ConnectRequestImpl(DestinationRoutingAddress destinationRoutingAddress, AlertingPatternCap alertingPattern,
            OriginalCalledNumberCap originalCalledPartyID, CAPExtensions capExtensions, Carrier carrier,
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        ...
        try {
            ((DestinationRoutingAddressImpl) this.destinationRoutingAddress).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
                    _ID_destinationRoutingAddress);

            if (this.alertingPattern != null)
                ((AlertingPatternCapImpl) this.alertingPattern).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_alertingPattern);
            ...
            if (this.capExtensions != null)
                ((CAPExtensionsImpl) this.capExtensions).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_extensions);
            ...
            if (this.redirectionInformation != null)
                ((RedirectionInformationInapImpl) this.redirectionInformation).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
            ...
            if (this.genericNumbers != null) {
                ...
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _ID_genericNumbers);
                int pos = asnOutputStream.StartContentDefiniteLength();
                for (GenericNumberCap gnc : this.genericNumbers) {
                    GenericNumberCapImpl gncc = (GenericNumberCapImpl) gnc;
                    gncc.encodeAll(asnOutputStream);
                }
                asnOutputStream.FinalizeContent(pos);
            }
            if (this.serviceInteractionIndicatorsTwo != null) {
                ((ServiceInteractionIndicatorsTwoImpl) this.serviceInteractionIndicatorsTwo).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_serviceInteractionIndicatorsTwo);
            }
            ...
            if (this.legToBeConnected != null) {
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _ID_legToBeConnected);
                int pos = asnOutputStream.StartContentDefiniteLength();
                ((LegIDImpl) this.legToBeConnected).encodeAll(asnOutputStream);
                asnOutputStream.FinalizeContent(pos);
            }
            ...
            if (this.suppressionOfAnnouncement)
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_suppressionOfAnnouncement);
            if (this.ocsIApplicable)
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_oCSIApplicable);
            ...
            if (this.borInterrogationRequested) {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_bor_InterrogationRequested);
            }
