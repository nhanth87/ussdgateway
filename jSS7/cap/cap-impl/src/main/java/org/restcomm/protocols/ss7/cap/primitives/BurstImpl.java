...
*
*/
@JacksonXmlRootElement(localName = "burst")
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        ...
        try {
            if (numberOfBursts != null)
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_numberOfBursts, numberOfBursts);
            if (burstInterval != null)
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_burstInterval, burstInterval);
            if (numberOfTonesInBurst != null)
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_numberOfTonesInBurst, numberOfTonesInBurst);
            if (toneDuration != null)
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_toneDuration, toneDuration);
            if (toneInterval != null)
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_toneInterval, toneInterval);
        } catch (IOException e) {
