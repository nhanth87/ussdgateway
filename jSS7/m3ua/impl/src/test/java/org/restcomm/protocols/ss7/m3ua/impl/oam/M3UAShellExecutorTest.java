...
public class M3UAShellExecutorTest {
    ...
    public void testServerCommands() throws Exception {
        ...
        assertEquals(result, String.format(M3UAOAMMessages.CREATE_AS_SUCCESSFUL, "testas", this.clientM3UAMgmt.getName()));
        ...
        assertEquals(String.format(M3UAOAMMessages.CREATE_AS_SUCCESSFUL, "testas1", this.clientM3UAMgmt.getName()), result);
        ...
        result = m3uaExec
                .execute("m3ua as create testas2 AS mode DE ipspType CLIENT rc 100 traffic-mode loadshare network-appearance 12"
                        .split(" "));
        assertEquals(String.format(M3UAOAMMessages.CREATE_AS_SUCCESSFUL, "testas2", this.clientM3UAMgmt.getName()), result);
        ...
        assertEquals(String.format(M3UAOAMMessages.CREATE_AS_SUCCESSFUL, "MTUAS", this.clientM3UAMgmt.getName()), result);

        // create ASP with only mandatory params
        result = m3uaExec.execute("m3ua asp create testasp1 testAssoc1".split(" "));
        assertEquals(String.format(M3UAOAMMessages.CREATE_ASP_SUCCESSFUL, "testasp1", this.clientM3UAMgmt.getName()), result);
        ...
        assertEquals(result, String.format(M3UAOAMMessages.CREATE_ASP_SUCCESSFUL, "testasp2", this.clientM3UAMgmt.getName()));
        ...
        assertEquals(
                String.format(M3UAOAMMessages.ADD_ASP_TO_AS_SUCCESSFUL, "testasp1", "testas", this.clientM3UAMgmt.getName()),
                result);
        ...
        assertEquals(
                String.format(M3UAOAMMessages.ADD_ROUTE_AS_FOR_DPC_SUCCESSFUL, "testas", 2, this.clientM3UAMgmt.getName()),
                result);

        // Start Asp
        result = m3uaExec.execute("m3ua asp start testasp1".split(" "));
        assertEquals(String.format(M3UAOAMMessages.ASP_START_SUCCESSFUL, "testasp1", this.clientM3UAMgmt.getName()), result);
        ...
        assertEquals(
                result,
                String.format(M3UAOAMMessages.REMOVE_ASP_FROM_AS_SUCCESSFUL, "testasp1", "testas",
                        this.clientM3UAMgmt.getName()));

        // Destroy Asp
        result = m3uaExec.execute("m3ua asp destroy testasp1".split(" "));
        assertEquals(result, String.format(M3UAOAMMessages.DESTROY_ASP_SUCCESSFUL, "testasp1", this.clientM3UAMgmt.getName()));
        ...
        assertEquals(
                String.format(M3UAOAMMessages.REMOVE_AS_ROUTE_FOR_DPC_SUCCESSFUL, "testas", 2, this.clientM3UAMgmt.getName()),
                result);

        // Destroy As
        result = m3uaExec.execute("m3ua as destroy testas".split(" "));
        assertEquals(result, String.format(M3UAOAMMessages.DESTROY_AS_SUCCESSFUL, "testas", this.clientM3UAMgmt.getName()));
    ...
    class TransportManagement implements Management {
        ...
        @Override
        public Server addServer(String serverName, String hostAddress, int hostPort, IpChannelType ipChannelType,
                 boolean acceptAnonymousConnections, int maxConcurrentConnectionsCount, int maxInputSctpStreams,
                 int maxOutputSctpStreams, String[] extraHostAddresses) throws Exception {
            return null;
        }
