...
public class IPSPClientFSMTest {
    ...
    public void testSingleAspInAsWithRCSE() throws Exception {
        ...
        // TODO fix this, the SCTP association is not connected, therefore the following asserts don't apply
        ...
        // Let's wait for 3 seconds to receive the MTP3 primitive before giving up. We know Pending timeout is 2 secs
