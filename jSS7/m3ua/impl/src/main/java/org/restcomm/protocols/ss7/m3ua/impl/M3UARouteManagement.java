 ...
 * </p>
 * <p>
 * The DPC, OPC and SI of Message Signaling unit (MSU) transferred by M3UA-User to M3UA layer for routing is checked against
 ...
 * TrafficModeType configured load-sharing is achieved by using SLS from received MSU.
 * </p>
 * <p>
