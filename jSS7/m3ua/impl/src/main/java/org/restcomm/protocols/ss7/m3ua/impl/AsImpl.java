...
public class AsImpl implements As {
    ...
    public AsImpl(String name, RoutingContext routingContext, TrafficModeType trafficModeType, int minAspActiveForLoadbalance,
        ...
        this.defaultTrafficModeType = this.parameterFactory.createTrafficModeType(TrafficModeType.Loadshare);
    ...
    private void initPeerFSM() {
        ...
        // STATE PENDING /
        // ******************************************************************/
        // As transitions to DOWN from PENDING when Pending Timer times out
        this.peerFSM.createTransition(TransitionState.AS_DOWN, AsState.PENDING.toString(), AsState.DOWN.toString());

        // As transitions to INACTIVE from PENDING when Pending Timer times out
     ...
     *
     * @param trafficModeType
     */
    protected void setTrafficModeType(TrafficModeType trafficModeType) {
    ...
    protected void setDefaultTrafficModeType() {
        // TODO : Check if TrafficModeType is not null throw error?
        this.trafficModeType = this.defaultTrafficModeType;
    }

    public TrafficModeType getDefaultTrafficModeType() {
        return this.defaultTrafficModeType;
    }
    ...
    public void show(StringBuffer sb) {
        ...
        if (this.routingContext != null) {
            sb.append(" rc=").append(Arrays.toString(this.routingContext.getRoutingContexts()));
        }

        if (this.trafficModeType != null) {
            sb.append(" trafficModeType=").append(this.trafficModeType.getMode());
        }

        sb.append(" defaultTrafficModeType=").append(this.defaultTrafficModeType.getMode());

        if (this.networkAppearance != null) {
            sb.append(" networkAppearance=").append(this.networkAppearance.getNetApp());
        }
